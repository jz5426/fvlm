...
def get_totalseg_dir():
    if "TOTALSEG_HOME_DIR" in os.environ:
        ...
        # totalseg_dir = Path('/cluster/projects/mcintoshgroup/totalsegmentator_pretrained_weights')
    else:
        ...
        home_path = Path('/cluster/projects/mcintoshgroup/totalsegmentator_pretrained_weights')
        totalseg_dir = home_path
    return totalseg_dir
...
def setup_nnunet():
    ...
    if "TOTALSEG_WEIGHTS_PATH" in os.environ:
        ...
        weights_dir = '/cluster/projects/mcintoshgroup/totalsegmentator_pretrained_weights'
    else:
        # in docker container finding home not properly working therefore map to /tmp
